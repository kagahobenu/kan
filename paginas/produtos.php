<div class="container mt-2">
    ...
    <div class="card-columns">
        <div class="card">
            <img class="card-img-top" src="https://www.placehold.it/100x100" alt="Imagem de capa do card">
            <div class="card-body">
        ...
        <div class="card">
            <img class="card-img" src="https://www.placehold.it/100x100" alt="Imagem do card">
        </div>
